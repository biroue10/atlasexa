  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-12">
      <div className="mx-auto max-w-6xl">
        ...
        <section
          className="mt-8 grid gap-4 rounded-2xl border border-slate-200 bg-white p-5 md:grid-cols-4"
          aria-labelledby="catalog-filters-title"
        >
          <h2 id="catalog-filters-title" className="sr-only">
            Product catalog filters
          </h2>

          <label className="grid gap-2 text-sm text-slate-700 md:col-span-4">
            Search products
            <input
              key={query}
              type="search"
        ...
        {!isLoading &&
          ...
          catalog.items.length === 0 && (
            <section className="mt-10 rounded-2xl border border-slate-200 bg-white px-6 py-14 text-center">
        ...
        {!isLoading && catalog && catalog.items.length > 0 && (
          <>
